...
struct Pose {
    ...
    PoseJoint& pelvis() { return joint(Pelvis); }
    ...
    Pose() {
        ...
        pelvis().configure(-45.f, 45.f, .015f);
        ...
        bone(PoseBoneID::LeftUpperLeg).configure(Pelvis, LeftKnee, -0.10f, 0.02f);
        ...
        bone(PoseBoneID::RightUpperLeg).configure(Pelvis, RightKnee, -0.10f, 0.02f);
        ...
        bone(PoseBoneID::Spine).configure(NeckBase, Pelvis, -0.05f, 0.07f);
